...
/**
 * Die vorderen KettenrŠder und die Ritzel hinten
 * modellieren die Gangschaltung eines Fahrrads. 
 * Die Anzahl der vorederen KettenrŠder ist beschrŠnkt von 1 bis 3 
 * und die Anzahl der Ritzel hinten ist beschrŠnkt von 1 bis 10.
 *
 */
public class Gears {
	...
	public void setChainWheelNr(int chainWheelNr) {
		if (chainWheelNr >= MIN_CHAINWHEEL_NR
			...
			+ "als Anzahl der KettenrŠder ist nicht gŸltig." +
			" Die Anzahl muss min 1 und max 3 betragen. Bitte Wert Šndern.");
		}
	}
	...
	public void setRitzNr(int ritzNr) {
		if (ritzNr >= MIN_RITZL_NR && ritzNr <= MAX_RITZL_NR) {
			...
			+ " als Anzahl der Ritzl ist nicht gŸltig." +
			" Die Anzahl muss min 1 und max 10 betragen. Bitte Wert Šndern.");
		}
	}
