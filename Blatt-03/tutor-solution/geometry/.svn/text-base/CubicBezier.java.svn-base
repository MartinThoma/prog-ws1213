...
public class CubicBezier {
    ...
    public CubicBezier(Point start, Point control1, Point control2, Point end) {
    ...
    public Point interpolate(double t) {
        return new QuadraticBezier(first.interpolate(t),
            new Line(first.getEndPoint(),
            second.getStartPoint()).interpolate(t),
            second.interpolate(t)).interpolate(t);
    }
    ...
    public CubicBezier mirrorAt(Point point) {
        return new CubicBezier(
            ...
            second.getStartPoint().mirrorAt(point),
    ...
    public CubicBezier mirrorAt(Line line) {
        return new CubicBezier(
            ...
            second.getStartPoint().mirrorAt(line),
